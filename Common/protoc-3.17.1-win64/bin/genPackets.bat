...
GenPacket.exe --path=./Protocol.proto --output=ClientPacketHandler --recv=S_ --send=C_
GenPacket.exe --path=./Protocol.proto --output=ServerPacketHandler --recv=C_ --send=S_
