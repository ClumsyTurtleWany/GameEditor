...
// GameEditorTest_Ver0.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CGameEditorTestVer0App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CGameEditorTestVer0App::OnAppAbout)
...
// CGameEditorTestVer0App 생성

CGameEditorTestVer0App::CGameEditorTestVer0App() noexcept
{
	...
	SetAppID(_T("GameEditorTestVer0.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CGameEditorTestVer0App 개체입니다.

CGameEditorTestVer0App theApp;


// CGameEditorTestVer0App 초기화
...
BOOL CGameEditorTestVer0App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CGameEditorTestVer0Doc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CGameEditorTestVer0View));
	if (!pDocTemplate)
		return FALSE;
...
int CGameEditorTestVer0App::ExitInstance()
{
...
// CGameEditorTestVer0App 메시지 처리기
...
void CGameEditorTestVer0App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CGameEditorTestVer0App 사용자 지정 로드/저장 방법

void CGameEditorTestVer0App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGameEditorTestVer0App::LoadCustomState()
{
}

void CGameEditorTestVer0App::SaveCustomState()
{
}
...
BOOL CGameEditorTestVer0App::OnIdle(LONG lCount)
{
