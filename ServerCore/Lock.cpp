...
void Lock::WriteLock(const char* name)
{
	...
	//아무도 소유 및 공유 하고있지 않은 경우, 스레드 경합으로 소유권을 얻음
	const int64 beginTick = GetTickCount64(); //시간 체크
...
#endif // _DEBUG
	//ReadLock 다 풀기 전에는 WriteUnlock불가능
