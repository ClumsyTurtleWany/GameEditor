...
struct Vertex
{
	...
	Vertex() : Pos(Vector3(0.0, 0.0, 0.0)), Normal(Vector3(0.0, 0.0, 0.0)), Color(Vector4(0.0, 0.0, 0.0, 0.0)), Texture(Vector2(0.0, 0.0)), Tangent(Vector3(0.0, 0.0, 0.0)) {};
	...
	Vertex(const Vector3& pos, const Vector3& normal, const Vector4& color, const Vector2& texture, const Vector3& tangent)
		: Pos(pos), Normal(normal), Color(color), Texture(texture), Tangent(tangent) {};
};